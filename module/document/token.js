...
export class ActorItemToken extends Token {
    ...
    async _canView(user, event) {
      ...
      if ( !this.actor ) {
        if (this.document.flags["magicalogia-new-testament"] == undefined || this.document.flags["magicalogia-new-testament"].uuid == undefined)
          ui.notifications.warn("TOKEN.WarningNoActor", {localize: true});
  
        const uuid = this.document.flags["magicalogia-new-testament"].uuid;
